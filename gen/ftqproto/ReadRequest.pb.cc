...
// source: ftqproto/ReadRequest.proto
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_ftqproto_2fReadRequest_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_ftqproto_2fReadRequest_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_ftqproto_2fReadRequest_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_ftqproto_2fReadRequest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_ftqproto_2fReadRequest_2eproto_getter() {
  return &descriptor_table_ftqproto_2fReadRequest_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_ftqproto_2fReadRequest_2eproto(&descriptor_table_ftqproto_2fReadRequest_2eproto);
namespace request {
...
::PROTOBUF_NAMESPACE_ID::Metadata ReadRequest::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_ftqproto_2fReadRequest_2eproto_getter, &descriptor_table_ftqproto_2fReadRequest_2eproto_once,
      file_level_metadata_ftqproto_2fReadRequest_2eproto[0]);
}
