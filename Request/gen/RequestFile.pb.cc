...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_RequestFile_2eproto[2];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_RequestFile_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::req::RequestFile, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::req::RequestFile, sourcefilepath_),
  PROTOBUF_FIELD_OFFSET(::req::RequestFile, filesize_),
  PROTOBUF_FIELD_OFFSET(::req::RequestFile, isdir_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::req::RequestFiles, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::req::RequestFiles, files_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::req::RequestFile)},
  { 8, -1, sizeof(::req::RequestFiles)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::req::_RequestFile_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::req::_RequestFiles_default_instance_),
};

const char descriptor_table_protodef_RequestFile_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021RequestFile.proto\022\003req\"F\n\013RequestFile\022"
  "\026\n\016sourceFilePath\030\001 \001(\t\022\020\n\010fileSize\030\002 \001("
  "\005\022\r\n\005isDir\030\003 \001(\010\"/\n\014RequestFiles\022\037\n\005file"
  "s\030\001 \003(\0132\020.req.RequestFileb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_RequestFile_2eproto = {
  false, false, 153, descriptor_table_protodef_RequestFile_2eproto, "RequestFile.proto", 
  &descriptor_table_RequestFile_2eproto_once, nullptr, 0, 2,
...
RequestFile::RequestFile(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:req.RequestFile)
}
RequestFile::RequestFile(const RequestFile& from)
  ...
  // @@protoc_insertion_point(copy_constructor:req.RequestFile)
}
...
RequestFile::~RequestFile() {
  // @@protoc_insertion_point(destructor:req.RequestFile)
  SharedDtor();
...
// @@protoc_insertion_point(message_clear_start:req.RequestFile)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "req.RequestFile.sourceFilePath"));
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* RequestFile::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:req.RequestFile)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->sourcefilepath().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "req.RequestFile.sourceFilePath");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:req.RequestFile)
  return target;
}

size_t RequestFile::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:req.RequestFile)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:req.RequestFile)
  GOOGLE_DCHECK_NE(&from, this);
  const RequestFile* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RequestFile>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:req.RequestFile)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:req.RequestFile)
    MergeFrom(*source);
  }
}

void RequestFile::MergeFrom(const RequestFile& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:req.RequestFile)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:req.RequestFile)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:req.RequestFile)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
RequestFiles::RequestFiles(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:req.RequestFiles)
}
RequestFiles::RequestFiles(const RequestFiles& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      files_(from.files_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:req.RequestFiles)
}
...
RequestFiles::~RequestFiles() {
  // @@protoc_insertion_point(destructor:req.RequestFiles)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
// @@protoc_insertion_point(message_clear_start:req.RequestFiles)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::PROTOBUF_NAMESPACE_ID::uint8* RequestFiles::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:req.RequestFiles)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:req.RequestFiles)
  return target;
}

size_t RequestFiles::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:req.RequestFiles)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:req.RequestFiles)
  GOOGLE_DCHECK_NE(&from, this);
  const RequestFiles* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RequestFiles>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:req.RequestFiles)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:req.RequestFiles)
    MergeFrom(*source);
  }
}

void RequestFiles::MergeFrom(const RequestFiles& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:req.RequestFiles)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:req.RequestFiles)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:req.RequestFiles)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata RequestFiles::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_RequestFile_2eproto_getter, &descriptor_table_RequestFile_2eproto_once,
      file_level_metadata_RequestFile_2eproto[1]);
}

// @@protoc_insertion_point(namespace_scope)
}  // namespace req
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_NOINLINE ::req::RequestFile* Arena::CreateMaybeMessage< ::req::RequestFile >(Arena* arena) {
  return Arena::CreateMessageInternal< ::req::RequestFile >(arena);
}
template<> PROTOBUF_NOINLINE ::req::RequestFiles* Arena::CreateMaybeMessage< ::req::RequestFiles >(Arena* arena) {
  return Arena::CreateMessageInternal< ::req::RequestFiles >(arena);
}
