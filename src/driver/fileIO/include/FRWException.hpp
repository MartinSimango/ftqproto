...
static std::string INVALID_FILE_SIZE =
    "A valid file size needs to be specified when creating a file.";
static std::string FAILED_TO_GET_FILE_SIZE = "Failed to get file size";

static std::string FAILED_TO_OPEN_FILE_FOR_WRITING =
...
static std::string FAILED_TO_WRITE_TO_DIRECTORY =
    "Failed to write to directory.";
static std::string FAILED_TO_WRITE_FILE_NOT_OPEN =
    "Cannot write to unopened file.";
static std::string FAILED_TO_READ_FILE_NOT_OPEN =
    "Cannot read to unopened file.";
static std::string FAILED_TO_CLOSE_FILE_NOT_OPEN =
...
public:
  ...
  /**
   * getFilename returns the filename/filepath relating to the thrown exception
   */
  std::string getFilename() const;

  /**
   * getErrorMessge returns the error message that caused the exception to be
   * thrown
