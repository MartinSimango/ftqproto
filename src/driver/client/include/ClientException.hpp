...
static const char *FAILED_TO_CONNECT_TO_SERVER =
    "Failed to connect to the server.";

static const char *FAILED_TO_CREATE_CLIENT_SOCKET =
    "Failed to create the client socket.";
static const char *CLIENT_NOT_CONNECTED =
    "The client is not connected to the server.";
static const char *CLIENT_ALREADY_CONNECTED =
