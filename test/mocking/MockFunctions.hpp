...
#define FUNC_ARGS_N( func_name, n)  decltype(createMemberFunctionWrapper( func_name ) )::Nth<n>
...
#define MOCK_METHOD(returnType, methodName, ...) MOCK_METHOD_I(returnType, methodName,##__VA_ARGS__, 9, 8, 7, 6, 5, 4, 3, 2, 1, __VA_ARGS__)

#define MOCK_METHOD_I(returnType, methodName,_9,_8,_7,_6,_5,_4,_3,_2,_1,X,...) MOCK_METHOD_##X(returnType, methodName, ##__VA_ARGS__)

#define MOCK_METHOD_(returnType, methodName) returnType methodName() override { \
    return registry->get<returnType>(#methodName);                \
} 
#define MOCK_METHOD_1(returnType, methodName, arg_1) returnType methodName(arg_1 a) override { \
    return registry->get<returnType>(#methodName, a);                \
} 

#define MOCK_METHOD_2(returnType,methodName,_1,arg_1,arg_2) returnType methodName(arg_1 a, arg_2 b) override { \
    return registry->get<returnType>(#methodName, a,b);                \
} 


#define MOCK_METHOD_3(returnType, methodName,_1,_2, arg_1, arg_2, arg_3) returnType methodName(arg_1 a, arg_2 b, arg_3 c) override { \
    return registry->get<returnType>(#methodName, a,b,c);                                                                      \
}

#define MOCK_METHOD_4(returnType, methodName,_1,_2,_3, arg_1, arg_2, arg_3, arg_4) returnType methodName(arg_1 a, arg_2 b, arg_3 c, arg_4 d) override { \
    return registry->get<returnType>(#methodName, a,b,c,d);                \
} 
#define MOCK_METHOD_5(returnType, methodName,_1,_2,_3, _4, arg_1, arg_2, arg_3, arg_4, arg_5) returnType methodName(arg_1 a, arg_2 b, arg_3 c, arg_4 d, arg_5 e) override { \
...
interface##Mock interface##Mock##_instance; //this ensures mock implements all interface methods \

// #define MOCK(interface, method) MOCK_N(interface, method, ) AF(std::get<GET_FUNC_WRAPPER(&interface::method).S>(GET_FUNC_WRAPPER(&interface::method).tuple)...)


#define MOCK_0(interface, method) FUNC_RETURN_TYPE(&interface::method) method() override { \
    return registry->get<FUNC_RETURN_TYPE(&interface::method)>(#method);      \
}    

#define MOCK_1(interface, method) FUNC_RETURN_TYPE(&interface::method) method(FUNC_ARGS_N(&interface::method, 0) a) override { \
    return registry->get<FUNC_RETURN_TYPE(&interface::method)>(#method, a);  \
}

#define MOCK_2(interface, method) FUNC_RETURN_TYPE(&interface::method) method(FUNC_ARGS_N(&interface::method, 0) a, FUNC_ARGS_N(&interface::method, 1) b) override { \
    return registry->get<FUNC_RETURN_TYPE(&interface::method)>(#method, a,b); \
}

#define MOCK_3(interface, method) FUNC_RETURN_TYPE(&interface::method) method(FUNC_ARGS_N(&interface::method, 0) a, FUNC_ARGS_N(&interface::method, 1) b. FUNC_ARGS_N(&interface::method, 2) c) override { \
    return registry->get<FUNC_RETURN_TYPE(&interface::method)>(#method, a,b, c); \
}

#define MOCK_4(interface, method) FUNC_RETURN_TYPE(&interface::method) method(FUNC_ARGS_N(&interface::method, 0) a, FUNC_ARGS_N(&interface::method, 1) b, FUNC_ARGS_N(&interface::method, 2) c , FUNC_ARGS_N(&interface::method, 3) d) override{  \
    return registry->get<FUNC_RETURN_TYPE(&interface::method)>(#method, a, b, c, d); \
} 


// #define MOCK(interface, method) MOCK_N(interface, method, GET_FUNC_WRAPPER(&interface::method).Size) 
