...
// repeated .request.RequestFile files = 1;
inline int GetResponse::_internal_files_size() const {
  return files_.size();
}
inline int GetResponse::files_size() const {
  return _internal_files_size();
}
inline ::request::RequestFile* GetResponse::mutable_files(int index) {
...
GetResponse::mutable_files() {
  // @@protoc_insertion_point(field_mutable_list:response.GetResponse.files)
  return &files_;
}
inline const ::request::RequestFile& GetResponse::_internal_files(int index) const {
  return files_.Get(index);
}
inline const ::request::RequestFile& GetResponse::files(int index) const {
  // @@protoc_insertion_point(field_get:response.GetResponse.files)
  return _internal_files(index);
}
inline ::request::RequestFile* GetResponse::_internal_add_files() {
  return files_.Add();
}
inline ::request::RequestFile* GetResponse::add_files() {
  // @@protoc_insertion_point(field_add:response.GetResponse.files)
  return _internal_add_files();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::request::RequestFile >&
GetResponse::files() const {
  // @@protoc_insertion_point(field_list:response.GetResponse.files)
  return files_;
}
...
inline const ::response::ResponseStatus& GetResponse::_internal_status() const {
...
inline const ::response::ResponseStatus& GetResponse::status() const {
  // @@protoc_insertion_point(field_get:response.GetResponse.status)
  return _internal_status();
}
inline void GetResponse::unsafe_arena_set_allocated_status(
    ::response::ResponseStatus* status) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:response.GetResponse.status)
}
inline ::response::ResponseStatus* GetResponse::release_status() {
...
inline ::response::ResponseStatus* GetResponse::unsafe_arena_release_status() {
  // @@protoc_insertion_point(field_release:response.GetResponse.status)
  
  ::response::ResponseStatus* temp = status_;
  status_ = nullptr;
  return temp;
}
inline ::response::ResponseStatus* GetResponse::_internal_mutable_status() {
...
inline ::response::ResponseStatus* GetResponse::mutable_status() {
  // @@protoc_insertion_point(field_mutable:response.GetResponse.status)
  return _internal_mutable_status();
}
inline void GetResponse::set_allocated_status(::response::ResponseStatus* status) {
  ...
  status_ = status;
  // @@protoc_insertion_point(field_set_allocated:response.GetResponse.status)
}
