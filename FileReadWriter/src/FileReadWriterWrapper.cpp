...
void * OpenFile(void* frw) {
    Error<void, FileReadWriter> * error = new Error<void, FileReadWriter>(&FileReadWriter::Open, AsFileReadWriter(frw));
    error->Execute();
...
void * CloseFile(void* frw){
    Error<void, FileReadWriter> * error = new Error<void, FileReadWriter>(&FileReadWriter::Close, AsFileReadWriter(frw));
    error->Execute();
...
void * WriteToFile(void *frw, int offset, const char * data) {
    Error<int, FileReadWriter, int, const char *> * error = new Error<int, FileReadWriter,int, const char *> (&FileReadWriter::WriteToFile, AsFileReadWriter(frw));
...
void * ReadFromFile(void *frw, char * data, int offset, int numberOfBytesToRead) {
    Error<int, FileReadWriter, char *, int, int> * error = new Error<int, FileReadWriter, char *, int, int> (&FileReadWriter::ReadFromFile, AsFileReadWriter(frw));
